...
public abstract class MaskField<R extends ConnectRecord<R>> implements Transformation<R> {
    ...
    private static final String HASH_CONFIG = "hash";
    ...
    public static final ConfigDef CONFIG_DEF = new ConfigDef()
		    ...
		    .define(HASH_CONFIG, ConfigDef.Type.STRING, null, new ConfigDef.NonEmptyString(),
		            ConfigDef.Importance.LOW, "Custom value hash, that will be applied to all"
		                    + " 'fields' values (numeric or non-empty string values only).");
    ...
    public void configure(Map<String, ?> props) {
        ...
        hash = config.getString(HASH_CONFIG);
    }
...
//    암호화를 위한 함수
    ...
    private Object masked(Object value) {
        ...
        if("SHA256".equals(hash) && value instanceof String) {
        	try {
        		return replacement == null ? maskWithNullValue(value) : maskWithCustomReplacement(value, sha256.encrypt(vlaue.toString()));
//        		return sha256.encrypt(vlaue.toString());
